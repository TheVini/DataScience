...
- [4. K-Fold cross-validation and testing - With skewed data and no attribute selection](https://github.com/TheVini/DataScience/blob/master/classification/swiss_banknote/README.md#4-k-fold-cross-validation-and-testing---with-skewed-data-and-no-attribute-selection)
