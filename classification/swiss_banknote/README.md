...
- [4. K-Fold cross-validation and testing - With skewed data and no attribute selection](https://github.com/TheVini/DataScience/tree/master/classification/swiss_banknote#4-k-fold-cross-validation-and-testing---with-skewed-data-no-attribute-selection-and-dataset-size-for-test-30)
